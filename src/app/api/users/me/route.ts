  ...
  if (profileData) {
    await prisma.handymanProfile.upsert({
      ...
      update: {
        ...
        ...(profileData.licenseNumber !== undefined && { licenseNumber: profileData.licenseNumber }),
        ...(profileData.isInsured    !== undefined && { isInsured: profileData.isInsured }),
        ...(profileData.verificationStatus !== undefined && { verificationStatus: profileData.verificationStatus }),
      ...
      create: {
        ...
        isInsured: profileData.isInsured ?? false,
