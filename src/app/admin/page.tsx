              ...
              <tbody className="divide-y">
                {handymanLeads.map((lead) => (
                  <tr key={lead.id} className="align-top">
                    ...
                    <td className="max-w-md py-4 pr-4 text-xs leading-5 text-muted-foreground">{lead.notes || 'No additional details.'}</td>
